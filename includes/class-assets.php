	...
	public static function get_localized_config(): array {
		...
		return [
			...
			'i18n'             => [
				...
				'errorUnavailable'      => esc_html__( 'The assistant is temporarily unavailable. Please try again.', 'gemini-chat-assistant' ),
				'errorNotConfigured'    => esc_html__( 'The AI assistant is not configured yet. Please configure the API key in settings.', 'gemini-chat-assistant' ),
				'geminiRateLimited' => esc_html__( 'The assistant is temporarily busy. Please try again shortly.', 'gemini-chat-assistant' ),
				'errorAuthFailed'       => esc_html__( 'The assistant is not configured correctly.', 'gemini-chat-assistant' ),
				'errorModelUnavailable' => esc_html__( 'The selected AI model is currently unavailable.', 'gemini-chat-assistant' ),
				...
				'chatRateLimited'       => esc_html__( 'You\'re sending messages too quickly. Please try again in {seconds}s.', 'gemini-chat-assistant' ),
				'rateLimited'           => esc_html__( 'You\'re sending messages too quickly. Please try again in {seconds}s.', 'gemini-chat-assistant' ),
