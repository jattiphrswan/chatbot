	...
	public static function get_localized_config(): array {
		...
		return [
			...
			'i18n'             => [
				...
				'errorTimeout'      => esc_html__( 'The assistant timed out. Please try again.', 'gemini-chat-assistant' ),
				'errorTooLong'      => esc_html__( 'Your message exceeds the maximum allowed length.', 'gemini-chat-assistant' ),
				'errorUnavailable'  => esc_html__( 'The chat assistant is temporarily unavailable.', 'gemini-chat-assistant' ),
				'errorDisabled'     => esc_html__( 'The chat assistant is currently disabled.', 'gemini-chat-assistant' ),
				'networkError'      => esc_html__( 'Network error connecting to the chat server.', 'gemini-chat-assistant' ),
			],
		];
	}
}
